...
- 新增 `.claude/`、`.codex/`、`.github/copilot-instructions.md`、`.github/instructions/**/*.instructions.md`、`.comate/`、`docs/AI-*.md` 或 `rules/ai-*.md` 下的 AI 协作资产时，必须纳入治理清单、引用规则或显式豁免，防止 rules/skills 文档游离在门禁之外。
