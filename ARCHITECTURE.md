...
| 文件 | 说明 |
|------|------|
| `reward-response.redacted.json` | 脱敏激励广告响应样本，保留 rewardImpl、rewardDialog、deeplink、easybrowse、openapp、资源 URL 和占位符形态 |
...
| `landing-response.redacted.json` | 脱敏落地页响应样本，覆盖 easybrowse、deeplink、openapp、结构化 HTTPS 落地页、监测 URL 和占位符 |
