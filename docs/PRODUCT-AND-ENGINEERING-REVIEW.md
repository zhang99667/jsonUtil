...
- 关键模块体量:
  - `frontend/src/utils/transformSummary.ts`: 3461 行
  - `frontend/src/utils/schemeUtils.ts`: 2380 行
  - `frontend/src/components/TransformReportPanel.tsx`: 2408 行
...
- 给资源类型 Top 增加一键筛选和占比展示，帮助 PM 判断素材问题是否集中在视频、图片或 Lottie 等资源形态。
