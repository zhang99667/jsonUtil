...
- 状态分类: 协作资产、权威流程、决策账本、工具薄入口、可迁移技能、治理门禁、显式豁免。没有状态说明的 AI 相关文件不应进入长期维护面。
...
| `docs/AI-GOVERNANCE-DECISIONS.md` | 决策账本 | 记录 AI rules、skills 和治理脚本变更的触发条件、反例、回写追踪和锁定测试 | 必需文件、docs/AI 引用规则、资产发现规则 |
