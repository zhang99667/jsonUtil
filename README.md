...
*   **JSONPath 查询**: 内置强大的 JSONPath 查询面板，支持字段名快捷查询、常用示例、Response 常见字段预设、收藏/历史、结果预览、路径和值复制以及 PREVIEW 高亮定位，轻松排查真实接口数据。
