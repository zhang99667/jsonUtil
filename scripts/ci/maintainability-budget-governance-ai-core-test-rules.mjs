...
import { governanceAiEvolutionTestMaintainabilityBudgets } from './maintainability-budget-governance-ai-evolution-test-rules.mjs';
...
export const governanceAiCoreTestMaintainabilityBudgets = [
  governanceAiCoreTestBudget('scripts/ci/maintainability-budget-governance-ai-core-test-rules.mjs', 25, 'AI 治理核心测试预算父表应只组合核心支撑、安全、决策和 scorecard 测试预算子表'),
  ...governanceAiEvolutionTestMaintainabilityBudgets,
