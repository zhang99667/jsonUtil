...
export const governanceAiMcpHelperTestMaintainabilityBudgets = [
  ...
  mcpHelperTestBudget('scripts/mcp/jsonutils-governance-method-params.test.mjs', 65, 'JSONUtils 治理 MCP method params 测试应直接锁定初始化、资源、工具、控制消息与 typed cancellation 参数 shape'),
  ...
  mcpHelperTestBudget('scripts/mcp/jsonutils-governance-worktree.test.mjs', 80, 'JSONUtils 治理 MCP worktree orchestration 测试应锁定固定 Git 失败、parser 错误结构和真实 Git 展开'),
  mcpHelperTestBudget('scripts/mcp/jsonutils-governance-worktree-parser.test.mjs', 65, 'JSONUtils 治理 MCP worktree parser 测试应锁定 NUL 分帧、branch、copy/conflict、Unicode/rename、计数和非法路径负例'),
