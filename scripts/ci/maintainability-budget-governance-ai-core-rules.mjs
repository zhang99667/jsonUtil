...
export const governanceAiCoreMaintainabilityBudgets = [
  ...
  governanceAiCoreBudget('scripts/ci/aiGovernanceValidationChangedSet.mjs', 450, 'validation changed-set helper 集中维护 HEAD、index、worktree 原始证据与异常索引状态'),
  governanceAiCoreBudget('scripts/ci/aiGovernanceValidationWhitespace.mjs', 400, 'validation whitespace helper 只编排三视图原始字节与 Git 空白语义检查'),
