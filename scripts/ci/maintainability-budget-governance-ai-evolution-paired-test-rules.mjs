...
export const governanceAiEvolutionPairedTestMaintainabilityBudgets = [
  ...
  pairedTestBudget('scripts/ci/aiGovernanceEvolutionPairedReceiptV4BatchContract.test.mjs', 70, 'Paired v4 batch contract 直接测试锁紧凑 JSON、闭字段、敏感值、归一化与 512 KiB 上限'),
  pairedTestBudget('scripts/ci/aiGovernanceEvolutionPairedReceiptV4.test.mjs', 180, 'Paired v4 verifier 测试应锁 candidate-only、infra 分层、proof 隔离与上下文篡改'),
