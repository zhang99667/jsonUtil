...
export const governanceAiReportRuntimeMaintainabilityBudgets = [
  governanceAiReportRuntimeBudget('scripts/ci/maintainability-budget-governance-ai-report-runtime-rules.mjs', 20, 'AI 治理报告 runtime 预算子表应组合 CLI、报告组装、失败分组和产物脚本预算'),
  ...
  governanceAiReportRuntimeBudget('scripts/ci/aiGovernanceReport.mjs', 25, 'AI 治理报告组装应只组合上下文与失败列表'),
  ...
  governanceAiReportRuntimeBudget('scripts/ci/writeAiGovernanceArtifactFreshness.mjs', 45, 'AI 治理 artifact freshness helper 应独立维护旧产物语义比较和 generatedAt 剥离'),
  governanceAiReportRuntimeBudget('scripts/ci/writeAiGovernanceArtifactPayloads.mjs', 65, 'AI 治理 artifact payload helper 应独立组装报告、context、scorecard 和 summary 载荷'),
