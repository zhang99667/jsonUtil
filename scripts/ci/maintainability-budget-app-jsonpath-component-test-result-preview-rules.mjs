...
export const appJsonPathComponentTestResultPreviewMaintainabilityBudgets = [
  ...
  appJsonPathComponentTestResultPreviewBudget('frontend/src/components/JsonPathPanelResultPreviewRow.test.tsx', 55, 'JSONPath 结果预览行测试只锁定聚焦按钮装配和结构定位入口装配'),
  appJsonPathComponentTestResultPreviewBudget('frontend/src/components/JsonPathPanelResultPreviewFocusButton.test.tsx', 55, 'JSONPath 结果预览聚焦按钮测试只锁定按钮属性、结果内容和点击下标'),
