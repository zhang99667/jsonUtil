...
export const appWorkflowCommandTemplateMaintainabilityBudgets = [
  ...
  commandTemplateBudget('frontend/src/utils/appTemplateFillCommandRunner.test.ts', 120, '模板填充命令 runner 测试只锁定普通模板、占位符质量 delta、SOURCE 竞态和错误文案'),
  commandTemplateBudget('frontend/src/utils/appTemplateFillCommandRunnerTestFixture.ts', 90, '模板填充命令 runner 测试 fixture 只维护模块 mock、默认 effects 和执行包装'),
