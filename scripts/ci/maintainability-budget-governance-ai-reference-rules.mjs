...
export const governanceAiReferenceMaintainabilityBudgets = [
  ...
  governanceAiReferenceBudget('scripts/ci/aiGovernanceEntryReferenceRules.mjs', 60, 'AI 治理入口文档引用规则应集中维护入口、Playbook、README 和工具说明的关键引用'),
  governanceAiReferenceBudget('scripts/ci/aiGovernanceDocReferenceRules.mjs', 35, 'AI 治理 docs/AI 文档引用规则应独立维护历史说明与当前治理入口的关键引用'),
  ...
  governanceAiReferenceBudget('scripts/ci/aiGovernancePlaybookSectionRules.mjs', 25, 'AI 治理 Playbook 章节引用规则应独立维护章节标题和章节内关键词映射'),
  governanceAiReferenceBudget('scripts/ci/aiGovernanceToolEntryReferenceRules.mjs', 30, 'AI 治理工具薄入口引用规则应独立维护 Cursor 和 Comate 的同源入口契约'),
