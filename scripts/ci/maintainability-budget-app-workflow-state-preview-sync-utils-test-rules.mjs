export const appWorkflowStatePreviewSyncUtilsTestMaintainabilityBudgets = [
  ...
  { file: 'frontend/src/utils/appPreviewOutputChangeTask.test.ts', maxLines: 55, reason: 'PREVIEW 输出变更 task 测试只锁定任务入参映射和 scheduler 调用' },
  { file: 'frontend/src/utils/appPreviewOutputChangeHandler.test.ts', maxLines: 65, reason: 'PREVIEW 输出变更 handler helper 测试只锁定草稿、即时校验和调度入参' },
