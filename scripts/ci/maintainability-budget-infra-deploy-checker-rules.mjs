export const infraDeployCheckerMaintainabilityBudgets = [
  ...
  { file: 'scripts/ci/deployWorkflowRunChecks.mjs', maxLines: 45, reason: 'Workflow run 检查应只负责文件存在、run 块表达式边界和 bash -n 分发' },
  ...
  { file: 'scripts/ci/deployShellHeredocs.mjs', maxLines: 35, reason: '部署脚本 heredoc 提取应只识别脚本 marker 并组装脚本片段' },
  ...
  { file: 'scripts/ci/sshDeployTargetValidation.test.mjs', maxLines: 105, reason: 'SSH 部署边界测试只锁定目标参数白名单和远端动态值的标准输入传递' },
];
