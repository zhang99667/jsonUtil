...
export const governanceAiMcpContractMaintainabilityBudgets = [
  mcpContractBudget('scripts/ci/maintainability-budget-governance-ai-mcp-contract-rules.mjs', 10, 'AI 治理 MCP 契约预算子表应只维护 MCP 配置、运行时契约和本地 server 条目'),
  ...
  mcpContractBudget('scripts/mcp/jsonutils-governance-server.mjs', 170, 'JSONUtils 治理 MCP server 应只暴露只读资源、固定报告工具和 stdio framing'),
];
