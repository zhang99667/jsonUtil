...
export const governanceAiEntryContractMaintainabilityBudgets = [
  entryContractBudget('scripts/ci/maintainability-budget-governance-ai-entry-contract-rules.mjs', 15, 'AI 治理入口契约预算子表应只维护同源入口、共享片段和章节引用契约条目'),
  entryContractBudget('scripts/ci/aiGovernanceMirroredEntryContracts.mjs', 75, 'AI 治理同源入口契约应独立维护镜像章节和共享片段漂移检查'),
