...
export const infraStaticRetentionMaintainabilityBudgets = [
  ...
  staticRetentionBudget('frontend/scripts/frontend-seo-contract.mjs', 120, '前端 SEO 契约单源只维护站点身份、元数据、发现文件与源码产物检查'),
  staticRetentionBudget('scripts/ci/frontendSeoContract.mjs', 35, '仓库 SEO 契约入口只组合前端本地检查与 Nginx 公开路由检查'),
