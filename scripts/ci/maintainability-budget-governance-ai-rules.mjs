...
export const governanceAiMaintainabilityBudgets = [
  ...
  governanceAiBudget('scripts/ci/aiGovernanceDelegationReferenceGroup.mjs', 15, 'AI 治理子 Agent 委派引用组应独立维护任务边界和输出契约关键词'),
  ...
  governanceAiBudget('scripts/ci/aiGovernanceEvolutionReferenceGroup.mjs', 15, 'AI 治理进化引用组应独立维护规则沉淀质量门槛关键词'),
