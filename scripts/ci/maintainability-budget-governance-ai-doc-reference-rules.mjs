...
export const governanceAiDocReferenceMaintainabilityBudgets = [
  ...
  governanceAiDocReferenceBudget('scripts/ci/aiGovernanceDocReferenceItems.mjs', 30, 'AI 治理 docs/AI 配置分层引用项应独立维护工程与演进 Playbook 的关键引用'),
  governanceAiDocReferenceBudget('scripts/ci/aiGovernanceToolsSetupReferenceItems.mjs', 35, 'AI 治理工具索引引用项应独立维护工具入口、双 Playbook、专用 skill 和 JSON 报告关键引用'),
];
