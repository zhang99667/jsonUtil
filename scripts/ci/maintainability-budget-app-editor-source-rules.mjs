export const appEditorSourceMaintainabilityBudgets = [
  ...
  { file: 'frontend/src/components/editorTabViewStateHandlers.ts', maxLines: 80, reason: '编辑器 Tab viewState handler 只维护切换、新建、关闭前保存当前 Monaco 光标和滚动状态的动作边界' },
  { file: 'frontend/src/components/editorTabViewStateHandlers.test.ts', maxLines: 115, reason: '编辑器 Tab viewState handler 测试只覆盖切换、当前 Tab 点击、关闭、新建和无 viewState 保护路径' },
