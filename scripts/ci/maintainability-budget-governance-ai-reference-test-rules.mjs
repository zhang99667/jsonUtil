...
export const governanceAiReferenceTestMaintainabilityBudgets = [
  ...
  governanceAiReferenceTestBudget('scripts/ci/aiGovernanceReferenceToolEntryMissingCases.mjs', 75, 'AI 治理工具入口引用负例应独立维护根入口、Claude README、Cursor 和 Comate 用例'),
  ...
  governanceAiReferenceTestBudget('scripts/ci/aiGovernanceSectionReferenceRules.test.mjs', 85, 'AI 治理章节引用规则测试应独立维护必读顺序和 AI 安全章节负例'),
