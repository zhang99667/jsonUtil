...
export const governanceAppWorkflowStateMaintainabilityBudgets = [
  ...
  stateGovernanceBudget('scripts/ci/maintainability-budget-app-workflow-state-preview-sync-rules.mjs', 25, 'App PREVIEW 同步预算规则应独立维护同步 hook、scheduler 和 request/result helper'),
];
