...
export const governanceAiAutomationContractMaintainabilityBudgets = [
  ...
  governanceAiAutomationContractBudget('scripts/ci/aiGovernanceCiContract.mjs', 32, 'AI 治理 CI 契约检查应只维护必需治理命令和自动化入口比对'),
  ...
  governanceAiAutomationContractBudget('scripts/ci/aiGovernanceAutomationCommandContract.mjs', 80, 'AI 治理自动化命令契约应单源维护 workflow 结构、完整 Git 历史、required command 可达性、artifact fail-fast 与 outcome 自动写账禁令'),
