...
export const governanceAiEvolutionLearningTestMaintainabilityBudgets = [
  ...
  learningTestBudget('scripts/ci/aiGovernanceEvolutionFeedbackSource.test.mjs', 140, 'Feedback source 测试应锁稳定普通文件、严格 UTF-8/BOM、资源上限、物理计数与无值诊断'),
  ...
  learningTestBudget('scripts/ci/aiGovernanceEvolutionFeedbackProfiles.test.mjs', 160, 'Feedback profile 测试应锁三个 candidate builder、固定 case/experiment、跨事件 chain 与 v2/v3 边界'),
