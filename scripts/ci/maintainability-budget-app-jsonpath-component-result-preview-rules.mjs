...
export const appJsonPathComponentResultPreviewMaintainabilityBudgets = [
  ...
  appJsonPathComponentResultPreviewBudget('frontend/src/components/JsonPathPanelResultPreviewRow.tsx', 35, 'JSONPath 结果预览行只维护聚焦按钮和结构定位入口装配，行选中态 className 留在纯 helper'),
  appJsonPathComponentResultPreviewBudget('frontend/src/components/JsonPathPanelResultPreviewRowClassName.ts', 20, 'JSONPath 结果预览行 className helper 只维护基础布局、选中态和悬停态样式派生'),
  appJsonPathComponentResultPreviewBudget('frontend/src/components/JsonPathPanelResultPreviewFocusButton.tsx', 40, 'JSONPath 结果预览聚焦按钮只维护聚焦入口样式、标题、无障碍标签、内容和点击下标'),
