...
import { transformCoreSupportMaintainabilityBudgets } from './maintainability-budget-transform-core-support-rules.mjs';
import { transformCoreRuntimeMaintainabilityBudgets } from './maintainability-budget-transform-core-runtime-rules.mjs';
...
export const transformCoreMaintainabilityBudgets = [
  ...
  ...transformCoreSupportMaintainabilityBudgets,
  ...transformCoreRuntimeMaintainabilityBudgets,
  {
