...
export const governanceAppJsonPathComponentTestMaintainabilityBudgets = [
  ...
  governanceAppJsonPathComponentTestBudget('scripts/ci/maintainability-budget-app-jsonpath-component-test-result-preview-rules.mjs', 15, 'JSONPath 结果预览测试预算规则应维护预览容器、列表、行和提示测试条目'),
