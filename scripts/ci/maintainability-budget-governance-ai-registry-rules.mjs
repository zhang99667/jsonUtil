...
export const governanceAiRegistryMaintainabilityBudgets = [
  ...
  governanceAiRegistryBudget('scripts/ci/aiGovernanceAssetRegistryClassifications.mjs', 40, 'AI 治理资产注册表分类 helper 应独立维护状态、责任人、复核节奏枚举和组合语义校验'),
  governanceAiRegistryBudget('scripts/ci/aiGovernanceAssetRegistryFailures.mjs', 40, 'AI 治理资产注册表失败汇总应独立维护缺登记、重复登记和陈旧登记错误'),
  governanceAiRegistryBudget('scripts/ci/aiGovernanceAssetRegistryRows.mjs', 60, 'AI 治理资产注册表 Markdown 表格解析应独立维护目标表头、路径、状态、责任人、复核节奏、类型、维护契约、治理证据和重复登记抽取'),
];
