...
export const governanceAiRegistryMaintainabilityBudgets = [
  ...
  governanceAiRegistryBudget('scripts/ci/aiGovernanceAssetRegistryClassifications.mjs', 30, 'AI 治理资产注册表分类 helper 应独立维护状态、责任人、复核节奏和最近复核日期校验'),
  governanceAiRegistryBudget('scripts/ci/aiGovernanceAssetRegistryClassificationCombinations.mjs', 25, 'AI 治理资产注册表分类组合 helper 应独立维护状态、责任人和复核节奏组合语义校验'),
