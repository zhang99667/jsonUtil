...
export const governanceAiValidationMaintainabilityBudgets = [
  ...
  validationBudget('scripts/ci/aiGovernanceRequiredValidationFiles.mjs', 25, 'Validation 必需资产子表应只登记 changed-set、registry、runtime、executor/receipt、whitespace 与对应测试和 CLI'),
  ...
  validationBudget('scripts/ci/aiGovernanceValidationExecution.mjs', 520, 'Validation executor 应只维护零执行 blocker、逐命令前后状态复核、启动尝试计数与 runtime 生命周期'),
