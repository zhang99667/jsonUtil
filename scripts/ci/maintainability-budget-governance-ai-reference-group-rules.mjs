...
export const governanceAiReferenceGroupMaintainabilityBudgets = [
  governanceAiReferenceGroupBudget('scripts/ci/maintainability-budget-governance-ai-reference-group-rules.mjs', 20, 'AI 治理引用组预算规则应独立维护委派、安全、进化、发布和运行时引用组预算'),
  ...
  governanceAiReferenceGroupBudget('scripts/ci/aiGovernanceRuntimeReferenceGroups.mjs', 55, 'AI 治理运行时引用组应统一维护通用、AI 基建与 maintainer 分层的验证闭环'),
];
