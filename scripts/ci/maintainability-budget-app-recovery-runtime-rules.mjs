...
export const appRecoveryRuntimeMaintainabilityBudgets = [
  ...
  runtimeBudget('frontend/src/utils/chunkLoadRecoveryMessages.ts', 70, 'chunk 加载错误消息查找只维护有界迭代读取、短路匹配、字段隔离和循环保护'),
  runtimeBudget('frontend/src/utils/chunkLoadRecovery.test.ts', 145, 'chunk 加载恢复测试只锁定错误识别、深宽遍历预算、敌意字段和各恢复入口'),
  ...
  runtimeBudget('frontend/src/components/ErrorBoundary.tsx', 90, '全局错误边界应保持安全兜底展示和少量恢复动作，不承载业务流程'),
  runtimeBudget('frontend/src/components/ErrorBoundary.test.tsx', 85, '全局错误边界测试只锁定正常渲染、动态资源恢复和敌意错误对象边界'),
];
