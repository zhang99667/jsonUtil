...
export const governanceAiEvolutionLearningMaintainabilityBudgets = [
  ...
  learningBudget('scripts/ci/aiGovernanceRequiredEvolutionLearningFiles.mjs', 40, 'Learning 必需资产清单应只登记 feedback、profiles、source、compatibility、experiment、learning report、producer 与对应测试'),
