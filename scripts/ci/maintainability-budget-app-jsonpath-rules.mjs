...
export const appJsonPathMaintainabilityBudgets = [
  appJsonPathBudget('frontend/src/components/JsonPathPanel.tsx', 795, 'JSONPath 面板组件继续承载 UI、worker 和面板状态，复制格式化、结果工具条、预览项派生、结果预览、导航、查询建议和标题文案等逻辑应下沉到 helper/子组件'),
