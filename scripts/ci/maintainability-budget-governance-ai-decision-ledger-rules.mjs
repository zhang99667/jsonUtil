...
export const governanceAiDecisionLedgerMaintainabilityBudgets = [
  ...
  governanceAiDecisionLedgerBudget('scripts/ci/aiGovernanceDecisionLedgerBackfillContract.mjs', 25, 'AI 治理决策账本回写契约应只编排账本自追踪、CHANGELOG 和路径安全契约'),
  governanceAiDecisionLedgerBudget('scripts/ci/aiGovernanceDecisionLedgerBackfillPathContract.mjs', 50, 'AI 治理决策账本回写路径契约应独立维护 canonical 仓内普通文件与稳定身份校验'),
