export const transformSummaryInsightSchemaResourceMaintainabilityBudgets = [
  ...
  { file: 'frontend/src/utils/transformReportResourceTypeGroupDraftState.ts', maxLines: 45, reason: '深度解析资源类型草稿状态应独立维护 schema 去重与展示上限规则' },
  { file: 'frontend/src/utils/transformReportResourceTypeGroupDrafts.ts', maxLines: 50, reason: '深度解析资源类型草稿聚合应保持独立纯函数，避免展示映射规则和计数去重互相耦合' },
