...
export const governanceAppJsonPathHelperMaintainabilityBudgets = [
  ...
  governanceAppJsonPathHelperBudget('scripts/ci/maintainability-budget-app-jsonpath-helper-rules.mjs', 15, 'JSONPath helper 预算入口应只组合 core、UI 和 saved-query 子表'),
