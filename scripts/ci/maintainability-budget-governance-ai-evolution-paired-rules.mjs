...
export const governanceAiEvolutionPairedMaintainabilityBudgets = [
  ...
  pairedBudget('scripts/ci/aiGovernanceEvolutionPairedReceiptV4BatchContract.mjs', 210, 'Paired v4 batch contract 只维护 512 KiB 精确紧凑 JSON、闭字段 shape、敏感字段拒绝与对象归一化'),
  pairedBudget('scripts/ci/aiGovernanceEvolutionPairedReceiptV4.mjs', 390, 'Paired v4 verifier 只维护当前上下文绑定、六 trial trace/treatment、基础设施、proof 与 candidate-only reducer'),
