...
export const governanceAiEvolutionPairedMaintainabilityBudgets = [
  pairedBudget('scripts/ci/maintainability-budget-governance-ai-evolution-paired-rules.mjs', 16, 'Paired evolution 预算子表只维护 v4 proof、verifier、candidate、writer、CLI 与必需资产'),
