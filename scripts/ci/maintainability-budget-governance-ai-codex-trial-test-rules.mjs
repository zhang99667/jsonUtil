...
export const governanceAiCodexTrialTestMaintainabilityBudgets = [
  trialTestBudget('scripts/ci/maintainability-budget-governance-ai-codex-trial-test-rules.mjs', 14, 'Codex trial 测试预算子表应只维护 adapter、profile、runtime 子表、CLI 与 fixture 测试'),
