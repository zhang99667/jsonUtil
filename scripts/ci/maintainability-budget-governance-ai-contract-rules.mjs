...
export const governanceAiContractMaintainabilityBudgets = [
  ...
  governanceAiContractBudget('scripts/ci/maintainability-budget-governance-ai-skill-contract-rules.mjs', 25, 'AI 治理 skill 契约预算子表应只组合 Codex skill 内容、结构、引用、上下文预算、章节和命令契约'),
