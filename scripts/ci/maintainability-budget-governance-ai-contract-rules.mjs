...
export const governanceAiContractMaintainabilityBudgets = [
  ...
  governanceAiContractBudget('scripts/ci/aiGovernanceCodexSkillCommandBlocks.mjs', 10, 'AI 治理 Codex skill 命令块抽取应独立复用 fenced code block 解析'),
  governanceAiContractBudget('scripts/ci/aiGovernanceCodexSkillDirectoryContract.mjs', 35, 'AI 治理 Codex skill 目录契约应独立维护 fenced cd 工作目录可达性校验'),
  ...
  governanceAiContractBudget('scripts/ci/aiGovernanceCodexSkillNpmScriptContract.mjs', 35, 'AI 治理 Codex skill npm 脚本契约应独立维护 fenced npm run 可达性校验'),
