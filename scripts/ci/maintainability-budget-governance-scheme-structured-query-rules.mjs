export const governanceSchemeStructuredQueryMaintainabilityBudgets = [
  ...
  { file: 'scripts/ci/maintainability-budget-scheme-support-structured-query-assign-rules.mjs', maxLines: 25, reason: 'Scheme 结构化 Query 赋值预算规则应只维护赋值入口、路径遍历和节点合并条目' },
