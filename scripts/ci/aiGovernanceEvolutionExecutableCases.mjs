...
export const AI_EVOLUTION_EXECUTABLE_CASES = Object.freeze({
  ...
  'observable-trace-receipt-boundary': {
    ...
    evidenceScope: 'deterministic-case',
    evidence: ['单条 receipt contract、稳定有界 source、严格 UTF-8、稠密闭字段 observation、preview 稳定性、recovery mutation 如实投影、receipt v2 完整性与 valid/verified 分层正反例'],
    argsList: [
      nodeTest('scripts/ci/aiGovernanceEvolutionTrialReceiptContract.test.mjs'),
      nodeTest(
