...
export const governanceAppWorkflowMaintainabilityBudgets = [
  ...
  governanceAppWorkflowBudget('scripts/ci/maintainability-budget-governance-app-workflow-command-rules.mjs', 20, 'App 命令预算治理规则应独立维护 command/core/template/panel 子表预算'),
