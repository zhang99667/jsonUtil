export const appWorkflowSettingsBackupMaintainabilityBudgets = [
  ...
  { file: 'frontend/src/utils/appSettingsBackupBrowserEffects.ts', maxLines: 40, reason: '设置备份浏览器副作用 adapter 只维护动态加载、文件大小保护、公共下载委托和本地存储入口' },
  { file: 'frontend/src/utils/appSettingsBackupBrowserEffects.test.ts', maxLines: 45, reason: '设置备份浏览器下载副作用测试只锁定公共下载委托和异常透传' },
