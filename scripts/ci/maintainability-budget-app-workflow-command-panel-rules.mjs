...
export const appWorkflowCommandPanelMaintainabilityBudgets = [
  commandPanelBudget('frontend/src/hooks/useAppToolPanelCommands.ts', 230, '主应用工具面板命令 hook 只维护面板状态、开关命令装配和子命令聚合，请求 ID 与具体动作编排不得回流'),
  ...
  commandPanelBudget('frontend/src/utils/appToolPanelToggleCommand.ts', 50, '工具面板开关命令 helper 只维护深度解析兜底和开关事件派发'),
  commandPanelBudget('frontend/src/utils/appToolPanelToggleConfigs.ts', 45, '工具面板开关配置只维护面板打开关闭事件名和深度解析要求'),
