...
export const transformSummaryArtifactTypesMaintainabilityBudgets = [
  ...
  summaryArtifactTypesBudget('frontend/src/utils/transformSummaryQualitySnapshotTypes.ts', 45, '深度解析质量快照入口只组合主契约和兼容 re-export，指标与热点类型继续拆分治理'),
  summaryArtifactTypesBudget('frontend/src/utils/transformSummaryQualitySnapshotMetricTypes.ts', 35, '深度解析质量快照指标与截断类型应独立维护，避免快照入口回涨'),
  summaryArtifactTypesBudget('frontend/src/utils/transformSummaryQualitySnapshotHotspotTypes.ts', 45, '深度解析质量快照热点类型应独立维护，避免快照入口回涨'),
