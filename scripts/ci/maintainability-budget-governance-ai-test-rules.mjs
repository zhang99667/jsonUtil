...
export const governanceAiTestMaintainabilityBudgets = [
  ...
  governanceAiTestBudget('scripts/ci/aiGovernanceDecisionLedger.test.mjs', 185, 'AI 治理决策账本测试应独立维护结构、路径、CI/MCP 覆盖和日期顺序负例'),
  ...
  governanceAiTestBudget('scripts/ci/aiGovernanceScriptReachability.test.mjs', 45, 'AI 治理脚本可达性测试应独立维护孤儿 helper、生产链路和测试支撑负例'),
