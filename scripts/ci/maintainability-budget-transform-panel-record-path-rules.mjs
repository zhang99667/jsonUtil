...
export const transformPanelRecordPathMaintainabilityBudgets = [
  ...
  pathBudget('frontend/src/components/transformReportRecordPathSectionHelpers.tsx', 75, '深度解析展开记录路径区块 helper 应只负责共享行样式和 section props 装配'),
  pathBudget('frontend/src/components/transformReportRecordPathMoreContent.tsx', 35, '深度解析展开记录更多提示 helper 应只负责索引数量文案拼装'),
