...
export const governanceAiReferenceSupportMaintainabilityBudgets = [
  ...
  governanceAiReferenceSupportBudget('scripts/ci/aiGovernancePlaybookSectionRules.mjs', 25, 'AI 治理文档章节引用规则应独立维护 Playbook 和工具索引的章节内关键词映射'),
  ...
  governanceAiReferenceSupportBudget('scripts/ci/aiGovernanceRequiredFiles.mjs', 35, 'AI 治理必需文件清单应独立维护基础入口和 Codex skill 展开规则'),
  governanceAiReferenceSupportBudget('scripts/ci/aiGovernanceRequiredCheckFiles.mjs', 25, 'AI 治理检查类必需文件清单应独立维护 CI、发布检查入口并组合 MCP 清单'),
  governanceAiReferenceSupportBudget('scripts/ci/aiGovernanceRequiredMcpFiles.mjs', 25, 'AI 治理 MCP 必需文件清单应独立维护 MCP 配置和固定 helper 文件集合'),
  governanceAiReferenceSupportBudget('scripts/ci/aiGovernanceCodexSkillReferenceRules.mjs', 25, 'AI 治理 Codex skill 引用规则应独立维护 lint、构建、部署和子 Agent 关键字'),
];
