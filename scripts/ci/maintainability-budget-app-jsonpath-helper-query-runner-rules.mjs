...
export const appJsonPathHelperQueryRunnerMaintainabilityBudgets = [
  ...
  appJsonPathHelperQueryRunnerBudget('frontend/src/hooks/useJsonPathPanelQueryRunner.test.ts', 175, 'JSONPath 查询 runner 测试只锁定 worker 请求、成功、旧请求晚到、取消、错误和卸载清理'),
  appJsonPathHelperQueryRunnerBudget('frontend/src/hooks/useJsonPathPanelQueryRunnerSkip.test.ts', 110, 'JSONPath 查询 runner 跳过分支测试只锁定准备中、空查询和空数据快捷输入接线'),
