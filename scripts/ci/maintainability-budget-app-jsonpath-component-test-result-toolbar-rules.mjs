...
export const appJsonPathComponentTestResultToolbarMaintainabilityBudgets = [
  ...
  appJsonPathComponentTestResultToolbarBudget('frontend/src/components/JsonPathPanelResultToolbarActionList.test.tsx', 65, 'JSONPath 结果工具条动作列表测试只锁定图标组件和点击接线'),
  appJsonPathComponentTestResultToolbarBudget('frontend/src/components/JsonPathPanelResultToolbarActionItems.test.ts', 55, 'JSONPath 结果工具条动作配置测试只锁定按钮顺序和禁用态'),
