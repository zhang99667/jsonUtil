...
export const governanceAppMaintainabilityBudgets = [
  ...
  governanceAppBudget('scripts/ci/maintainability-budget-app-interaction-hook-rules.mjs', 20, 'App 交互基础 hook 预算规则应只组合 PREVIEW setter、RAF、telemetry 和 scrollbar 子表'),
  governanceAppBudget('scripts/ci/maintainability-budget-app-interaction-scrollbar-rules.mjs', 15, 'App scrollbar 预算规则应独立维护滚动条 hook、纯 helper、DOM helper 和对应测试预算'),
