...
export const appJsonPathHelperSavedQueryMaintainabilityBudgets = [
  ...
  appJsonPathHelperSavedQueryBudget('frontend/src/hooks/useJsonPathSavedQueryListStorageSyncTestHarness.ts', 60, 'JSONPath 保存查询 storage sync 测试夹具只维护默认参数、窗口监听捕获和 effect cleanup 模拟'),
