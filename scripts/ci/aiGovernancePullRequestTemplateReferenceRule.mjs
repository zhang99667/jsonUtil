import { AI_GOVERNANCE_CUSTOM_AI_ENTRY_DIRS, AI_GOVERNANCE_MCP_CONFIG_FILES } from './aiGovernanceDiscoveryPatterns.mjs';
...
export const AI_GOVERNANCE_PULL_REQUEST_TEMPLATE_REFERENCE_RULE = {
  ...
  contains: ['docs/AI-ASSET-REGISTRY.md', 'docs/AI-GOVERNANCE-DECISIONS.md',
    ...
    ...AI_GOVERNANCE_CUSTOM_AI_ENTRY_DIRS, ...AI_GOVERNANCE_MCP_CONFIG_FILES,
    '显式豁免', '负向测试'],
};
