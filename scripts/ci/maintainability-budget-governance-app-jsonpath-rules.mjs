...
export const governanceAppJsonPathMaintainabilityBudgets = [
  ...
  governanceAppJsonPathBudget('scripts/ci/maintainability-budget-app-jsonpath-component-test-core-rules.mjs', 15, 'JSONPath 核心组件测试预算规则应维护输入区测试条目'),
  governanceAppJsonPathBudget('scripts/ci/maintainability-budget-app-jsonpath-component-test-result-rules.mjs', 15, 'JSONPath 结果组件测试预算规则应维护结果预览和工具条测试条目'),
