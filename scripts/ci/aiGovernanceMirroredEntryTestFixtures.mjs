...
export const mirroredAgentSection = [
  '## AI 协作与子 Agent 委派',
  '',
...
const authorityFiles = () => new Set(AI_ENTRY_SHARED_SNIPPET_DESCRIPTORS.map(({ authorityFile }) => authorityFile));

export const writeMirroredEntryFixture = (rootDir) => {
