...
test('AI 治理决策账本会报告日期顺序倒置', () => {
  withAiGovernanceTempRoot((rootDir) => {
    ...
    writeFixtureFile(rootDir, 'docs/AI-GOVERNANCE-DECISIONS.md', [
      ...
      '| 日期 | 决策 | 触发条件 | 反例 | 适用边界 | 回写追踪 | 锁定测试 |',
      '| --- | --- | --- | --- | --- | --- | --- |',
      '| 2026-07-07 | 旧记录 | 触发 | 反例 | 边界 | `docs/AI-ASSET-REGISTRY.md`, `CHANGELOG.md` | `node --test scripts/ci/aiGovernanceChecks.test.mjs`; `node scripts/ci/check-ai-governance.mjs` |',
      '| 2026-07-08 | 新记录 | 触发 | 反例 | 边界 | `docs/AI-ASSET-REGISTRY.md`, `CHANGELOG.md` | `node --test scripts/ci/aiGovernanceChecks.test.mjs`; `node scripts/ci/check-ai-governance.mjs` |',
    ].join('\n'));
