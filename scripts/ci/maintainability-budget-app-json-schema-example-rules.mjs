...
export const jsonSchemaExampleMaintainabilityBudgets = [
  ...
  jsonSchemaExampleBudget('frontend/src/utils/jsonSchemaExampleUniqueItems.test.ts', 60, 'Schema 唯一数组测试锁定结构相等、属性顺序和候选值生成语义'),
  ...
  jsonSchemaExampleBudget('frontend/src/utils/jsonSchemaValidation.ts', 380, 'Schema 校验入口只维护 JSON 解析、Ajv 版本选择、问题归一和报告文本'),
  jsonSchemaExampleBudget('frontend/src/utils/jsonSchemaValidation.test.ts', 300, 'Schema 校验测试锁定空态、解析与编译错误、关键字路径和脱敏报告'),
];
