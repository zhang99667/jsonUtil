...
export const governanceAppStructureNavMaintainabilityBudgets = [
  ...
  governanceAppStructureNavBudget('scripts/ci/maintainability-budget-app-structure-nav-component-rules.mjs', 15, '结构导航组件预算规则应只维护主面板和拆出的展示组件预算'),
  governanceAppStructureNavBudget('scripts/ci/maintainability-budget-app-structure-nav-test-rules.mjs', 15, '结构导航测试预算规则应只维护结构导航组件测试预算'),
