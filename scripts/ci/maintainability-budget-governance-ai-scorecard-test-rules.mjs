...
export const governanceAiScorecardTestMaintainabilityBudgets = [
  ...
  governanceAiScorecardTestBudget('scripts/ci/aiGovernanceMaturityScorecardHotspots.test.mjs', 120, 'AI 治理成熟度 scorecard 热点测试应锁定容量/职责分类、实现/测试优先级和反机械拆分边界'),
  governanceAiScorecardTestBudget('scripts/ci/aiGovernanceMaturityScorecardDistribution.test.mjs', 120, 'AI 治理分发就绪维度测试应锁定 unknown/fail/warn/pass 及 contract fail 优先级'),
