...
const tool = (name, description, inputSchema = emptySchema) => ({ name, description, inputSchema });

test('MCP governance tool definitions keep fixed order and bounded schemas', () => {
