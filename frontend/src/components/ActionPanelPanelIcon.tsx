...
import type { ActionPanelPanelIconId } from '../utils/actionPanelPanelItems';

interface ActionPanelPanelIconProps {
  iconId: ActionPanelPanelIconId;
}

export const ActionPanelPanelIcon: React.FC<ActionPanelPanelIconProps> = ({ iconId }) => {
  if (iconId === 'search') {
    return (
