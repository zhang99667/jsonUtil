...
const record: TransformReportRecord = {
  ...
  labels: ['JSON 字符串'],
  insights: ['cmdSchema=sampleapp://v1/open'],
  ...
  cmdStructureCopyText: '{"result":{"cmdSchema":"sampleapp://v1/open","cmdParams":{"uid":1}}}',
    ...
    const mismatch = buildSection({
      cmdComparison: {
        ...
        actualCandidate: {
          ...
          actual: { result: { cmdSchema: 'sampleapp://v1/other', cmdParams: {} } },
        },
        expectedText: '',
        ignoreExtraPaths: false,
